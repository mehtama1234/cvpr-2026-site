...
assert.equal(first.system, "controllable-generation-studio");
...
assert.equal(system.cluster, "Controllable generation");
assert.ok(system.avgScore >= 50);
console.log("ok controllable-generation-studio:", system.avgScore, system.cluster);
