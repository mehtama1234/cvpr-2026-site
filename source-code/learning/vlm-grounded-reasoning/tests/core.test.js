...
assert.equal(first.system, "vlm-grounded-reasoning");
...
assert.equal(system.cluster, "Vision-language reasoning");
assert.ok(system.avgScore >= 50);
console.log("ok vlm-grounded-reasoning:", system.avgScore, system.cluster);
