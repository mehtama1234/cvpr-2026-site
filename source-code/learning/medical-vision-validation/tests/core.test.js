...
assert.equal(first.system, "medical-vision-validation");
...
assert.equal(system.cluster, "Vision for science and medicine");
assert.ok(system.avgScore >= 50);
console.log("ok medical-vision-validation:", system.avgScore, system.cluster);
