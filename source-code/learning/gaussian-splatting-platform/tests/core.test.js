...
assert.equal(first.system, "gaussian-splatting-platform");
...
assert.equal(system.cluster, "Gaussian Splatting");
assert.ok(system.avgScore >= 50);
console.log("ok gaussian-splatting-platform:", system.avgScore, system.cluster);
