...
<body><header><div class="wrap"><div class="bug">CVPR 2026 · paper review</div><h1>Paper Review Queue</h1><p>A smaller review surface for checking whether the new paper notes are truly first-principles, detailed, and plain. Each card shows the hidden quantity, evidence, mathematical rule, naive failure, proof test, and counterexample.</p><nav><a href="index.html">all themes</a><a href="search.html">all papers</a><a href="paper-note-quality.html">quality audit</a><a href="first-principles-audit.html">first-principles audit</a><a href="math.html">math pages</a></nav></div></header>
