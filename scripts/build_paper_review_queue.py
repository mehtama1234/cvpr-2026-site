...
def card(record: dict, idx: int) -> str:
    ...
    return f"""<article class="card" id="paper-{idx}">
...
<main class="wrap"><section class="stats"><div class="stat"><b>{len(chosen)}</b><span>review papers</span></div><div class="stat"><b>{len(records)}</b><span>source papers</span></div><div class="stat"><b>8</b><span>themes balanced</span></div><div class="stat"><b>7</b><span>depth fields per paper</span></div>{stat_cards}</section><section class="queue">{cards}</section></main>
<footer><div class="wrap">Generated by scripts/build_paper_review_queue.py from search.html paper-depth records.</div></footer></body></html>"""
