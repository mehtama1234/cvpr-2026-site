...
INCIDENTS = [
    {"id": "launch-audit", "title": "Launch audit", "readinessShift": 0, "riskShift": 0, "evidenceShift": 0, "proPlusPenalty": 0},
    {"id": "gpu-brownout", "title": "GPU brownout", "readinessShift": -10, "riskShift": 8, "evidenceShift": -5, "proPlusPenalty": 4},
    {"id": "adversarial-content", "title": "Adversarial content", "readinessShift": -8, "riskShift": 18, "evidenceShift": -8, "proPlusPenalty": 0},
    {"id": "compound-launch", "title": "Compound launch", "readinessShift": -18, "riskShift": 25, "evidenceShift": -15, "proPlusPenalty": 5},
]
...
def summarize(demos, rows):
    ...
    gate = (
        ...
        and summary["gauntletRows"] == 32
        and summary["sourceRelease"] == 8
        and summary["review"] >= 8
        and summary["block"] >= 1
